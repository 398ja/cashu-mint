...
This reference lists the NUT specifications implemented in the repository.
...
- [NUT-04](https://github.com/cashubtc/nuts/blob/main/04.md): Mint tokens (including voucher mint quotes)
