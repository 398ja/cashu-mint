...
| [NUT-03](https://github.com/cashubtc/nuts/blob/main/03.md) | Swap tokens | `POST /v1/swap/{mint_id}` in `cashu-mint-rest` using swap logic from `cashu-mint-protocol`. |
| [NUT-04](https://github.com/cashubtc/nuts/blob/main/04.md) | Mint tokens | Mint quotes and issuance handled by both modules. |
| [NUT-05](https://github.com/cashubtc/nuts/blob/main/05.md) | Melt tokens | Melting endpoints in `cashu-mint-rest` backed by protocol redemption services (for example `POST /v1/melt/{mint_id}/{method}`). |
| [NUT-06](https://github.com/cashubtc/nuts/blob/main/06.md) | Mint information | Exposed via `/v1/info` endpoint. |
| [NUT-07](https://github.com/cashubtc/nuts/blob/main/07.md) | Token state check | `/v1/checkstate/{mint_id}` endpoint with protocol verification. |
| [NUT-09](https://github.com/cashubtc/nuts/blob/main/09.md) | Restore signatures | `/v1/restore` endpoint delegates to protocol restore task (NUT09). |
