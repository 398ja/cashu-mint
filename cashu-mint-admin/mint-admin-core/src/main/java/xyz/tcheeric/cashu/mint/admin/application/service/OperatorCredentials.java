 ...
 *
 * <p>A credential is random and is shown to the caller exactly once, at issue time. Only its
 * SHA-256 hash is ever persisted, so a disclosure of the operator table does not hand over working
 * credentials.
 */
