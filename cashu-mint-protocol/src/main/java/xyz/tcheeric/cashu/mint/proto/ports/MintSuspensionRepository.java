 ...
 *
 * <p>A suspended mint issues no new tokens but still honours swaps and melts, so
 * holders can always exit — see ADR-0006. The state lives with the mint and
 * survives a restart, because a mint that comes back up issuing again is the
 * failure suspending is meant to prevent (ADR-0007).
 */
