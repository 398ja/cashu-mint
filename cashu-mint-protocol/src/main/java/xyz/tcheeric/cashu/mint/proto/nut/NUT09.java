...
public class NUT09 {
    ...
    public static PostRestoreResponse restore(@NonNull PostRestoreRequest request) throws CashuErrorException {
        return restore(request, new DefaultSignatureVaultService());
    }
