 ...
 *
 * <p>Without this the guard could be deleted from the signing path and every other test would still
 * pass — the enforcement in ADR-0004 only holds if something asserts the call is actually made.
 */
...
class SignBlindedMessageTaskArchivedKeysetTest {
  ...
  @Mock private MintProtocolService mintProtocolService;

  @Mock private SignatureVaultService signatureVaultService;
