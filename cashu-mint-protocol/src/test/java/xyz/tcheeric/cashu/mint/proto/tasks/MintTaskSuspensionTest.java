 ...
 *
 * <p>Only issuance: swap and melt run through their own tasks and are untouched,
 * so a suspended mint keeps honouring redemption and holders can always exit.
...
class MintTaskSuspensionTest {
    ...
    @Mock
    private MintSuspensionRepository suspensions;

    @Mock
    private xyz.tcheeric.cashu.mint.proto.service.MintProtocolService mintProtocolService;

    @Mock
    private xyz.tcheeric.cashu.mint.proto.service.SignatureVaultService signatureVaultService;
    ...
    void refusesToIssueWhileSuspended() throws Exception {
        ...
        final MintTask<xyz.tcheeric.cashu.common.Secret> task = new MintTask<>(
